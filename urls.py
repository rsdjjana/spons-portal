...
urlpatterns = patterns('',
	...
	url(r'^remove_category_image/(\d+)/(\d+)/$','portal.views.remove_category_image', name='remove_category_image'),
	url(r'^addevents/(\d+)/$','portal.views.add_events',name='addevents'),
	url(r'^edit_event/(\d+)/(\d+)/$','portal.views.edit_event',name='edit_event'),
	url(r'^event/detail/(\d+)/(\d+)/$','portal.views.view_event_detail',name='view_event_image'),
	...
	url(r'^remove_event_image/(\d+)/(\d+)/(\d+)/$','portal.views.remove_event_image',name='remove_event_image'),
